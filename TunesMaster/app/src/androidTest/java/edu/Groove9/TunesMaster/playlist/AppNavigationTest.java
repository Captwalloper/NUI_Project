...
import static edu.Groove9.TunesMaster.TestUtils.getToolbarNavigationContentDescription;
import static edu.Groove9.TunesMaster.custom.action.NavigationViewActions.navigateTo;
...
/**
 * Tests for the {@link DrawerLayout} layout component in {@link PlaylistActivity} which manages
...
public class AppNavigationTest {
     ...
     */
    @Rule
    public ActivityTestRule<PlaylistActivity> mActivityTestRule =
            new ActivityTestRule<>(PlaylistActivity.class);
