...
package edu.Groove9.TunesMaster.tasks.domain.usecase;
...
import edu.Groove9.TunesMaster.tasks.TasksFilterType;
import edu.Groove9.TunesMaster.tasks.domain.filter.FilterFactory;
import edu.Groove9.TunesMaster.tasks.domain.filter.TaskFilter;
