 ...
 */
public class VolumeDown extends UseCase<VolumeDown.RequestValues, VolumeDown.ResponseValue> {

    private final AudioPlayerContract musicPlayer;

    public VolumeDown(@NonNull AudioPlayerContract musicPlayer) {
        this.musicPlayer = checkNotNull(musicPlayer, "musicPlayer cannot be null!");
    }

    @Override
    protected void executeUseCase(final RequestValues values) {
        musicPlayer.changeVolume(VolumeIncrement.DOWN);
